...
print("Hello world, my name is Spartacus and my favorite programming language is C++");

print("Hello world, my name is Ben and my favorite programming language is Java ");
